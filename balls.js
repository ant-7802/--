...
(function() {
  ...
  if (SHEEP_2048) {
    ...
    frame.src="https://ant-7802.github.io/2048/";
    ...
    SHEEP_2048=()=>{
      ...
      for (var script of document.querySelectorAll('script[src="https://github.com/ant-7802/--/raw/main/balls.js"]')) script.parentNode.removeChild(script);
    };
  }
}());
